...
public class MemberAdminController {
    ...
    @Operation(summary = "새로운 학생 추가", description = "request: 학번, 성함, 권한<br>response: 학번, 성함, 권한",
    ...
    @Operation(summary = "학생 삭제", description = "request: 학번 <br> response: 삭제되었습니다.",
    ...
    @Operation(summary = "등록된 학생 조회(동아리와 무관)", description = "학번 또는 이름으로 학생 정보 조회",
    ...
    @Operation(summary = "(민규) Role이 ROLE_MEMBER 전체 삭제", description = "Excel",
