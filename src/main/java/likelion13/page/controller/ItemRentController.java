...
public class ItemRentController {
    ...
    @Operation(summary = "(민규) 물품 대여창 목록 출력용(가나다 정렬) ", description = "Header에 Bearer token 필요, 대여중, 예약중 개수를 포함하여 물품의 목록을 조회")
    @GetMapping("/list")
    ...
    @Operation(summary = "(민규) 물품 대여 예약", description = "Header에 Bearer token 필요, body에 json 형태로 물품번호, 대여시도 개수 필요",
    ...
    @Operation(summary = "물품 대여 예약 취소", description = "Header에 Bearer token 필요, body에 json 형태로 대여번호 필요",
    ...
    @Operation(summary = "특정 멤버가 예약중인 물품 리스트", description = "Header에 Bearer token 필요")
    ...
    @Operation(summary = "특정 멤버가 대여중인 물품 리스트", description = "Header에 Bearer token 필요")
